...
import (
	monotonicclock "detection/internal/wasi/clocks/monotonic-clock"
	"detection/internal/wasi/io/poll"
	"detection/internal/wasi/io/streams"
	"detection/internal/wasi/sockets/network"
