...
// Package host represents the imported interface "tangent:logs/host@0.1.0".
package host
...
// Scalar represents the variant "tangent:logs/host@0.1.0#scalar".
//
//	variant scalar {
//		str(string),
//		int(s64),
...
// Logview represents the imported resource "tangent:logs/host@0.1.0#logview".
//
//	resource logview
...
// Res represents the enum "tangent:logs/host@0.1.0#res".
//
//	enum res {
//		ok,
//		full,
...
func (e Res) String() string {
	return _ResStrings[e]
}

// MarshalText implements [encoding.TextMarshaler].
func (e Res) MarshalText() ([]byte, error) {
	return []byte(e.String()), nil
}

// UnmarshalText implements [encoding.TextUnmarshaler], unmarshaling into an enum
// case. Returns an error if the supplied text is not one of the enum cases.
func (e *Res) UnmarshalText(text []byte) error {
	return _ResUnmarshalCase(e, text)
}

var _ResUnmarshalCase = cm.CaseUnmarshaler[Res](_ResStrings[:])

// Emit represents the imported function "emit".
//
//	emit: func(data: list<u8>) -> res
//
//go:nosplit
func Emit(data cm.List[uint8]) (result Res) {
	data0, data1 := cm.LowerList(data)
	result0 := wasmimport_Emit((*uint8)(data0), (uint32)(data1))
	result = (Res)((uint32)(result0))
	return
}
